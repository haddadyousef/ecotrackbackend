...
            
            // Update dayByDay array
            dayByDay[6] += CalculateduserEmissions
            
            // Update weekByWeek array
...
        // Remove the leaderboard view if it exists
        hostingController?.view.removeFromSuperview()
        hostingController = nil

        // Hide the leaderboard label
        leaderboardLabel.isHidden = true

        // Reset the car label text
        carLabel.text = "Main Menu"

        // Show the main menu buttons
        showNewButtons()

        // Ensure the home button is visible and properly positioned
...
remove the non-breaking spaces and replace with regular spaces